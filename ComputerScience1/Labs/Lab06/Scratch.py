...
p = float(input('Enter a probability (0.0 - 1.0) => '))
print(p)
        ...
        while True:
            ...
            if movement[1] <= p:
                ...
                if throw_pokeball(f, t) == True:
                    caught_pokemon +=1
                    table_as_list[trainer_location[0]][trainer_location[1]] +=1
                    t+=1
                else:
                    table_as_list[trainer_location[0]][trainer_location[1]] -=1
            ...
            if trainer_location[0] == 0 or trainer_location[1] == 0 or trainer_location[0] == size-1 or trainer_location[1] == size-1:
                turns.append((turn, simulation_number))
                total_turns+=turn
                break
...
print('Average number of turns in a simulation was {0:.2f}'.format(avg_num_turns))
