...
# -*- coding: utf-8 -*-
"""
Created on Wed Nov 20 14:10:56 2019
...
class BallDraw(object):
    def __init__ (self, parent):
        ...
        Ball.x, Ball.y = 200,200    # initial location
        Ball.r = 10
        Ball.dx, Ball.dy = 4,-2    # the movement of the ball object
        Ball.color = "green"
    ...
    def draw_ball(self):
        ...
        bounding_box = Ball.bounding_box(Ball)
    ...
    def animate(self):
        ...
        while Ball.some_inside(Ball, self.maxx, self.maxy) and not self.isstopped:
            # Move the ball
            self.draw_ball()
            Ball.check_and_reverse(Ball, self.maxx, self.maxy)
            Ball.move(Ball)
