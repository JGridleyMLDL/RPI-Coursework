...
public:
    ...
    void check_split(int i);        //Checks if leaf nodes need to be split
...
private:
    ...
    void recursive_split(Node* curr, int i, Rope& rhs);
    void copyRope(Node* original, Node* copy, bool side, bool first);
private:
    int size_;
    Node *root;
};
