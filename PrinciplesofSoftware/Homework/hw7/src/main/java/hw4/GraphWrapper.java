...
public class GraphWrapper {
    ...
    public void addEdge(String parentNode, String childNode, String edgeLabel){
        Edge new_edge = new Edge(parentNode, childNode, edgeLabel);
        ArrayList<Edge> new_edges = new ArrayList<Edge>(){{add(new_edge);}};
    ...
    public Iterator<String> listChildren(String parentNode){
        ...
        ArrayList<String> all_Children = new ArrayList<String>(children);
