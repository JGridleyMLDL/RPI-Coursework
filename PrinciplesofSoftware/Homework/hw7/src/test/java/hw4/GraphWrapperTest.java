...
public class GraphWrapperTest {
    ...
    ArrayList<String> Simple_Children = new ArrayList<>(Arrays.asList("B(14)", "B(tomorrow)", "C(7)"));
    ...
    ArrayList<String> Small_Vlist_Empty = new ArrayList<>(Arrays.asList("", "A", "C","D"));
    ArrayList<String> Simple_Children_NoLabel = new ArrayList<>(Arrays.asList("A()", "B()", "C()"));
    ...
    //test with out weights
    @Test
    public void TestListChildren_NoLabel() {
        Empty1.addEdge("", "A", "");
        Empty1.addEdge("A", "B", "");
        Empty1.addEdge("A", "C", "");
        Empty1.addEdge("C", "D", "");
        ...
        int i = 0;
        Iterator<String> AfterSmall = Empty1.listChildren("A");
        while(AfterSmall.hasNext()){assertEquals(AfterSmall.next(), Simple_Children_NoLabel.get(i)); i++;}
    }


    @Test
    public void TestListChildrenSpecific() {
        Empty1.addEdge("A", "A", "label1");
        Empty1.addEdge("A", "B", "label1");
        Empty1.addEdge("A", "B", "label2");
        Empty1.addEdge("A", "B", "label3");
        Empty1.addEdge("A", "C", "label1");

        Iterator<String> i = Empty1.listChildren("A");
        while(i.hasNext()) {
