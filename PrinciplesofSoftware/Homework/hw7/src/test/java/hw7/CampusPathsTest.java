...
public class CampusPathsTest { // Rename to the name of your "main" class
	...
	public void testInvalidID() throws Exception{
		runTest("testInvalidID");
	}

	@Test
	public void testConstructor(){
		CampusPaths c = new CampusPaths();
	}

	@Test
	public void testSmallPath() throws Exception {
		runTest("testSmallPath");
	}

	@Test
	public void testLargePath() throws Exception {
		runTest("testLargePath");
	}
