...
public class MarvelPaths2Test<T>{
    ...
    public void TestSmallGraph(){
        ...
        assertEquals(SmallGraph.findPath("FROST, CARMILLA", "M'SHULLA"), "path from FROST, CARMILLA to M'SHULLA:\n"+
                "24-HOUR MAN/EMMANUEL to G'RATH with weight 1.000\n"+
                "G'RATH to KILLRAVEN/JONATHAN R with weight 1.000\n"+
                "KILLRAVEN/JONATHAN R to M'SHULLA with weight 1.000\n"+
                "total cost: 1.000");
    ...
    public void TestLargeGraph(){
        MedGraph.createNewGraph("data/marvel.csv");
        /**
        assertEquals(MedGraph.findPath("PETERS, SHANA TOC", "SEERESS"), "path from PETERS, SHANA TOC to SEERESS:\n"+
